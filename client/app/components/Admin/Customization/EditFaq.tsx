...
const EditFaq = (props: Props) => {
  ...
  useEffect(() => {
    if (data) {
      // Ensure questions is always an array and add temporary IDs for new items
  ...
  const newFaqHandler = () => {
    setQuestions((prevQuestions) => [
      ...(prevQuestions || []),
      {
        _id: `temp_${Date.now()}`, // Add temporary ID for new items
        question: "",
        answer: "",
        active: true,
      },
  ...
  const areQuestionsUnchanged = (
    ...
    // Remove temporary IDs and active states for comparison
  ...
  const handleEdit = async () => {
    if (
      ...
      try {
        // Remove temporary IDs and active states before sending to backend
